...
public class NestedAdapter extends RecyclerView.Adapter<NestedAdapter.NestedViewHolder> {
    ...
    private final List<FuelStock> mList;

    /* Constructor */
    public NestedAdapter(List<FuelStock> mList) {
        this.mList = mList;
    }
...
//        holder.txtAvailableStock.setText(mList.get(position).arrivalTime);
        holder.txtArrivalTime.setText(mList.get(position).arrivalTime);
        holder.txtFinishTime.setText(mList.get(position).finishTime);
    }
